            ...
            <div class="card-content">
                <div class="block">
                    ...
                    <b-field label="Name" :label-position="labelPosition">
                        <b-input name="tenantapps-name" dusk="tenantapps-name" v-model="new_item.name"></b-input>
                    </b-field>

                    <b-field label="Slug" :label-position="labelPosition">
                        <b-input name="tenantapps-slug" dusk="tenantapps-slug" v-model="new_item.slug"></b-input>
                    </b-field>
