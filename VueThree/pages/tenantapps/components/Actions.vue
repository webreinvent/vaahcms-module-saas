        ...
        <div :class="{'flex justify-between items-start': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button size="small"
                        ...
                        data-testid="tenantsapps-actions-menu"
                        aria-haspopup="true"
            ...
            <div >
                ...
                <InputGroup>
                    <InputText v-model="store.query.filter.q"
                               ...
                               data-testid="tenantsapps-actions-search"
                               placeholder="Search"/>
                    <Button @click="store.delayedSearch()"
                            size="small"
                            data-testid="tenantsapps-actions-search-button"
                            icon="pi pi-search"/>
                    <Button v-if="!store.isMobile"
                            ...
                            data-testid="tenantsapps-actions-show-filters"
                    >
                    ...
                    <Button
                            ...
                            data-testid="tenantsapps-actions-reset-filters"
                            size="small"
                    ...
                    <Button
                            ...
                            data-testid="tenantsapps-actions-bulk-menu"
                            aria-haspopup="true"
