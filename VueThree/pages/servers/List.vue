            ...
            <div v-if="store.getLeftColumnClasses"
                ...
                <Panel :pt="root.panel_pt">
                    ...
                    <template #icons>
                        ...
                        <InputGroup >
                            <Button data-testid="servers-list-create"
                                    size="small"
                                    icon="pi pi-plus"
                                    label="Create"
                                    @click="store.toForm()">
                            ...
                            <Button data-testid="servers-list-reload"
                                    size="small"
                                    icon="pi pi-refresh"
                                    @click="store.getList()">
                            </Button>
                            ...
                            <Button v-if="root.assets && root.assets.module
                                    ...
                                    size="small"
                                    data-testid="servers-create-menu"
