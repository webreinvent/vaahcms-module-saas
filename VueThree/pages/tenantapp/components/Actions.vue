        ...
        <div :class="{'flex justify-between items-start': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button size="small"
                        ...
                        data-testid="tenantapp-actions-menu"
                        aria-haspopup="true"
            ...
            <div >
                ...
                <InputGroup>
                    <InputText v-model="store.query.filter.q"
                               ...
                               data-testid="tenantapp-actions-search"
                               placeholder="Search"/>
                    <Button @click="store.delayedSearch()"
                            size="small"
                            data-testid="tenantapp-actions-search-button"
                            icon="pi pi-search"/>
                    <Button v-if="!store.isMobile"
                            as="router-link"
                            :to="`/tenantapp/filters`"
                            type="button"
                            size="small"
                            :disabled="Object.keys(route.params).length"
                            data-testid="tenantapp-actions-show-filters"
                    >
                    ...
                    <Button
                            ...
                            data-testid="tenantapp-actions-reset-filters"
                            size="small"
                    ...
                    <Button
                            ...
                            data-testid="tenantapp-actions-bulk-menu"
                            aria-haspopup="true"
