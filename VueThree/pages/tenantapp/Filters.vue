...
<template>
    ...
    <Panel :pt="root.panel_pt" >
        ...
        <template #icons>
            ...
            <Button data-testid="tenantapp-hide-filter"
                    @click="store.toList()"
                    icon="pi pi-times"
                    rounded
                    variant="text"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-none"
                             inputId="sort-none"
                             data-testid="tenantapp-filters-sort-none"
                             value=""
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-ascending"
                             ...
                             data-testid="tenantapp-filters-sort-ascending"
                             value="updated_at"
                             v-model="store.query.filter.sort" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-descending"
                             ...
                             data-testid="tenantapp-filters-sort-descending"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-all"
                             inputId="active-all"
                             value="null"
                             data-testid="tenantapp-filters-active-all"
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-true"
                             inputId="active-true"
                             data-testid="tenantapp-filters-active-true"
                             value="true"
                             v-model="store.query.filter.is_active" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-false"
                             ...
                             data-testid="tenantapp-filters-active-false"
                             value="false"
                             v-model="store.query.filter.is_active" />
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="trashed-exclude"
                             ...
                             data-testid="tenantapp-filters-trashed-exclude"
                             value=""
            ...
            <div class="flex items-center gap-2">
                ...
                <RadioButton name="trashed-include"
                             ...
                             data-testid="tenantapp-filters-trashed-include"
                             value="include"
                             v-model="store.query.filter.trashed" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="trashed-only"
                             ...
                             data-testid="tenantapp-filters-trashed-only"
                             value="only"
                             v-model="store.query.filter.trashed" />
