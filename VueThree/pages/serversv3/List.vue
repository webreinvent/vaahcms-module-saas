            ...
            <div v-if="store.getLeftColumnClasses"
                ...
                <Panel :pt="root.panel_pt">
                    ...
                    <template #icons>
                        ...
                        <InputGroup >
                            <Button data-testid="serversv3-list-create"
                                    size="small"
                                    icon="pi pi-plus"
                                    label="Create"
                                    @click="store.toForm()">
                            ...
                            <Button data-testid="serversv3-list-reload"
                                    size="small"
                                    icon="pi pi-refresh"
                                    @click="store.getList()">
                            </Button>
                            ...
                            <Button v-if="root.assets && root.assets.module
                                    ...
                                    size="small"
                                    data-testid="serversv3-create-menu"
