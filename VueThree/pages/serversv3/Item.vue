        ...
        <template #icons>
            ...
            <div class="p-inputgroup">
                ...
                <Button label="Edit"
                        ...
                        data-testid="serversv3-item-to-edit"
                        icon="pi pi-save"/>
                ...
                <Button
                        ...
                        data-testid="serversv3-item-menu"
                ...
                <Button class="p-button-primary p-button-sm"
                        icon="pi pi-times"
                        data-testid="serversv3-item-to-list"
                        @click="store.toList()"/>
            ...
            <div class="p-datatable p-component p-datatable-responsive-scroll p-datatable-striped p-datatable-sm">
                <table class="p-datatable-table overflow-wrap-anywhere">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        || column === 'deleted_by' || column === 'password'">
                        </template>
                        ...
                        || column === 'deleted_by_user' || column === 'meta') && (typeof value === 'object' && value !== null)">
                            <VhViewRow :label="column"
                                       :value="value"
                                       type="user"
                            />
