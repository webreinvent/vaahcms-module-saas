...
<template>
    ...
    <Panel :pt="root.panel_pt" >
        ...
        <template #icons>
            ...
            <Button data-testid="serversv3-hide-filter"
                    @click="store.toList()"
                    icon="pi pi-times"
                    rounded
                    variant="text"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-none"
                             inputId="sort-none"
                             data-testid="serversv3-filters-sort-none"
                             value=""
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-ascending"
                             ...
                             data-testid="serversv3-filters-sort-ascending"
                             value="updated_at"
                             v-model="store.query.filter.sort" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="sort-descending"
                             ...
                             data-testid="serversv3-filters-sort-descending"
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-all"
                             inputId="active-all"
                             value="null"
                             data-testid="serversv3-filters-active-all"
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-true"
                             inputId="active-true"
                             data-testid="serversv3-filters-active-true"
                             value="true"
                             v-model="store.query.filter.is_active" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="active-false"
                             ...
                             data-testid="serversv3-filters-active-false"
                             value="false"
                             v-model="store.query.filter.is_active" />
        ...
        <div>
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="trashed-exclude"
                             ...
                             data-testid="serversv3-filters-trashed-exclude"
                             value=""
            ...
            <div class="flex items-center gap-2">
                ...
                <RadioButton name="trashed-include"
                             ...
                             data-testid="serversv3-filters-trashed-include"
                             value="include"
                             v-model="store.query.filter.trashed" />
            ...
            <div class="flex items-center gap-2">
                <RadioButton name="trashed-only"
                             ...
                             data-testid="serversv3-filters-trashed-only"
                             value="only"
                             v-model="store.query.filter.trashed" />
