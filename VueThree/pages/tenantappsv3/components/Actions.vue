        ...
        <div :class="{'flex justify-between items-start': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button size="small"
                        ...
                        data-testid="tenantappsv3-actions-menu"
                        aria-haspopup="true"
            ...
            <div >
                ...
                <InputGroup>
                    ...
                    <InputText v-model="store.query.filter.q"
                               ...
                               data-testid="tenantappsv3-actions-search"
                               placeholder="Search"/>
                    <Button @click="store.delayedSearch()"
                            size="small"
                            data-testid="tenantappsv3-actions-search-button"
                            icon="pi pi-search"/>
                    <Button v-if="!store.isMobile"
                            as="router-link"
                            :to="`/tenantappsv3/filters`"
                            type="button"
                            size="small"
                            :disabled="Object.keys(route.params).length"
                            data-testid="tenantappsv3-actions-show-filters"
                    >
                    ...
                    <Button
                            ...
                            data-testid="tenantappsv3-actions-reset-filters"
                            size="small"
                    ...
                    <Button
                            ...
                            data-testid="tenantappsv3-actions-bulk-menu"
                            aria-haspopup="true"
